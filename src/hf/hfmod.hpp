...
class hfmod {
 private:
  ...
  dbcsr::shared_matrix<double> compute_errmat(
      dbcsr::shared_matrix<double>& F,
      dbcsr::shared_matrix<double>& P,
 ...
 public:
  ...
  hfmod(create_pack&& p) :
      ...
      MAKE_INIT_LIST_OPT(HFMOD_LIST_OPT), LOG(m_world.comm(), m_print),
