...
#define MULT_BASE_LIST \
  (((util::optional<int>), first_row), ((util::optional<int>), first_col), \
   ((util::optional<int>), last_row), ((util::optional<int>), last_col), \
   ((util::optional<int>), first_k), ((util::optional<int>), last_k), \
 ...
 public:
  ...
  multiply_base(
      ...
      matrix<T>& C) :
      m_transa(transa),
      m_transb(transb), m_alpha(alpha), m_A(A), m_B(B), m_beta(beta), m_C(C)
  {
  }
  ...
  {
    c_dbcsr_multiply(
        m_transa, m_transb, m_alpha, m_A.m_matrix_ptr, m_B.m_matrix_ptr, m_beta,
        m_C.m_matrix_ptr, (c_first_row) ? &*c_first_row : nullptr,
        (c_last_row) ? &*c_last_row : nullptr,
        (c_first_col) ? &*c_first_col : nullptr,
        (c_last_col) ? &*c_last_col : nullptr,
        (c_first_k) ? &*c_first_k : nullptr, (c_last_k) ? &*c_last_k : nullptr,
...
multiply_base(
    ...
    matrix<T>& B,
    T beta,
    matrix<T>& C) -> multiply_base<typename matrix<T>::value_type>;
